...
class LyricsUpdate(BaseModel):
    ...
    LyricsUpdate
    """ # noqa: E501
    full_text: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["full_text", "chunks", "language", "confidence_score", "title", "creator", "duration_seconds", "thumbnail_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.full_text is None and "full_text" in self.model_fields_set:
            _dict['full_text'] = None
