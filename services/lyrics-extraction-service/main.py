...
from routes import health_router, lyrics_router
...
app = FastAPI(
    title="Karaoke-Inator Lyrics Extraction",
    description="AI-powered lyrics extraction service using Whisper speech recognition to transcribe audio to text",
    version="1.0.0",
    contact={
    ...
    openapi_tags=[
        {
            ...
            "description": "Extract lyrics from audio using speech recognition",
        },
        {
            "name": "Health",
